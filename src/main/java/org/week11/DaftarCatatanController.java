...
public class DaftarCatatanController implements Initializable {
    ...
    private FilteredList<Catatan> catatanObservableList;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        catatanObservableList = new FilteredList<>(FXCollections.observableList(FXCollections.observableArrayList()));
        ...
        searchBox.textProperty().addListener(
                (observableValue, oldValue, newValue) -> catatanObservableList.setPredicate(createPredicate(newValue))
        );
    ...
    private void getAllData() {
        ...
        ObservableList<Catatan> sementara = (ObservableList<Catatan>) catatanObservableList.getSource();
        sementara.clear();
    ...
    public void buttongrafik(ActionEvent event) {
